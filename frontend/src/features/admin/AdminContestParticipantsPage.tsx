...
export default function AdminContestParticipantsPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const contestRes = await api.get(`/contest/getById/${contestId}`);
            setContest(contestRes.data.contest);

            // 2. Fetch Submissions for this contest
            const submissionsRes = await api.get(`/submission/contestId/${contestId}`);
            ...
            const usersRes = await api.get('/user/getAll');
